...
public class MapResizeDialogTO extends BaseDialog{
    public static int minSize = -199, maxSize = 60000, increment = 50;

    int width, height, shiftX, shiftY;

    public MapResizeDialogTO(ResizeListener cons){
        ...
        shown(() -> {
            ...
            for(boolean w : Mathf.booleans){
                ...
                }).valid(value -> Strings.canParsePositiveInt(value) && Integer.parseInt(value) <= maxSize && Integer.parseInt(value) >= minSize).maxTextLength(30);
